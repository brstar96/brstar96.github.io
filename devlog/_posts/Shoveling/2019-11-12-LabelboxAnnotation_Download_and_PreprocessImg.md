...
tags: [Preprocessing, Labelbox, Data Labeling, ImageProcessing]
categories: [Shoveling]
comments: true
sitemap: true
image: /assets/img/devlog/shoveling/labelboxdownload/3.jpg
accent_image: 
...
![1.jpg](/assets/img/devlog/shoveling/labelboxdownload/1.jpg)<br>
...
![2_1.jpg](/assets/img/devlog/shoveling/labelboxdownload/2_1.jpg)<br>

라벨링을 어느 정도 끝내고 Export를 하게 되면 위와 같이 mask를 포함해 .json 또는 .csv 포맷으로 annotation 데이터를 다운로드받을 수 있습니다. <br><br>


![2.jpg](/assets/img/devlog/shoveling/labelboxdownload/2.jpg)<br>
...
![3.jpg](/assets/img/devlog/shoveling/labelboxdownload/3.jpg)<br>
...
![png](/assets/img/devlog/shoveling/labelboxdownload/output_8_1.png)
...
![png](/assets/img/devlog/shoveling/labelboxdownload/output_12_0.png)
...
![4.png](/assets/img/devlog/shoveling/labelboxdownload/4.png)<br>
...
![png](/assets/img/devlog/shoveling/labelboxdownload/output_22_0.png)
...
![5.jpg](/assets/img/devlog/shoveling/labelboxdownload/5.jpg)<br><br>
...
![6.jpg](/assets/img/devlog/shoveling/labelboxdownload/6.jpg)
...
![png](/assets/img/devlog/shoveling/labelboxdownload/output_32_1.png)


    (512, 512, 3)
    

![png](/assets/img/devlog/shoveling/labelboxdownload/output_32_3.png)
...
![png](/assets/img/devlog/shoveling/labelboxdownload/output_32_5.png)
